...
def main():
    ...
    training_data_cleaned , testing_data_cleaned, classes  = preprocess_data(symptom_df, testing_symptoms_df)
    ...
    def encode_user_symptoms(user_symptoms, all_symptoms, classes):
    ...
    # Encode user symptoms into model input
        X_input = encode_user_symptoms(symptoms, all_symptoms,classes)  # Define this function

    # Predict disease
        prediction = model.predict(X_input)
        predicted_disease = decode_prediction(prediction,classes)  # Define this function
